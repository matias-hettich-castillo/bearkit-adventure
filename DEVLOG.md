...
- Instalado Python 3.12.3
- Creado entorno virtual (.venv)
- Instalado Panda3D 1.10.16
- Proyecto inicial con main.py funcional
- Ventana Panda3D funcionando correctamente
...
- Proyecto nuevo limpio
- Enfoque en un juego 3D tercera persona
- No crear engine completo desde el inicio
